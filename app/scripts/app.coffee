...
angular.module('RSLWikiApp', ['ui.router','ngCookies','ngResource','ngSanitize','marked','ngTagsInput','underscore', 'angularLocalStorage', 'ui.codemirror', 'ngMaterial', 'moment', 'oitozero.ngSweetAlert'])
